...
const App: React.FC = () => {
  ...
  const handleClearData = () => {
    if (confirm("Are you sure? This will reset all your progress on this device.")) {
      ...
      localStorage.removeItem('focusflow_missions');
      localStorage.removeItem('focusflow_activities');
      localStorage.removeItem('focusflow_profile');
